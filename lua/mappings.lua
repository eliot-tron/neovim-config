-- remap functions --
function keyset(mode, shortcut, command, opts)
...
-- sidesearch quick map --
keyset('n', '<Leader>ss', ':SideSearch <C-r><C-w><CR> | wincmd p')
...
keyset('v', '<leader>ds', require('dap-python').debug_selection)
